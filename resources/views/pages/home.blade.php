...
@section('content')
    ...
    <div class="slider1-area overlay-default index1">
        <div class="bend niceties preview-1">
            <div id="ensign-nivoslider-3" class="slides">
                <img src="assets/img/slider/1-1.jpg" alt="slider" title="#slider-direction-1" />
                <img src="assets/img/slider/1-2.jpg" alt="slider" title="#slider-direction-2" />
                <img src="assets/img/slider/1-3.jpg" alt="slider" title="#slider-direction-3" />
            </div>
    ...
    <div class="about1-area">
        <div class="container">
            ...
            <p class="about-sub-title wow fadeIn" data-wow-duration="1s" data-wow-delay=".2s">Tmply dummy text of the
                printing and typesetting industry. Lorem Ipsum has been theindustry's standard dummy text ever since the
        ...
        <div id="shadow-carousel" class="container">
            <div class="rc-carousel" data-loop="true" data-items="4" data-margin="20" data-autoplay="false"
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/1.jpg" alt="courses">
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/2.jpg" alt="courses">
                            <a href="single-courses1.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        </div>
                        <div class="courses-content-wrapper">
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/3.jpg" alt="courses">
                            <a href="single-courses1.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        </div>
                        <div class="courses-content-wrapper">
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/4.jpg" alt="courses">
                            <a href="single-courses1.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        </div>
                        <div class="courses-content-wrapper">
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/5.jpg" alt="courses">
                            <a href="single-courses1.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        </div>
                        <div class="courses-content-wrapper">
                            <h3 class="item-title"><a href="#">Basic Philosopphy</a></h3>
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/6.jpg" alt="courses">
                            <a href="single-courses1.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        </div>
                        <div class="courses-content-wrapper">
                            <h3 class="item-title"><a href="#">GMAT</a></h3>
                ...
                <div class="courses-box1">
                    <div class="single-item-wrapper">
                        <div class="courses-img-wrapper hvr-bounce-to-bottom">
                            <img class="img-responsive" src="assets/img/course/7.jpg" alt="courses">
                            <a href="single-courses1.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        </div>
                        <div class="courses-content-wrapper">
                            <h3 class="item-title"><a href="#">Regular MBA</a></h3>
        ...
        <div class="container">
            <div class="rc-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="false"
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        <div class="lecturers-img-wrapper">
                            <a href="#"><img class="img-responsive" src="assets/img/team/1.jpg" alt="team"></a>
                        </div>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        <div class="lecturers-img-wrapper">
                            <a href="#"><img class="img-responsive" src="assets/img/team/2.jpg" alt="team"></a>
                        </div>
                        <div class="lecturers-content-wrapper">
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        <div class="lecturers-img-wrapper">
                            <a href="#"><img class="img-responsive" src="assets/img/team/3.jpg" alt="team"></a>
                        </div>
                        <div class="lecturers-content-wrapper">
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        <div class="lecturers-img-wrapper">
                            <a href="#"><img class="img-responsive" src="assets/img/team/4.jpg" alt="team"></a>
                        </div>
                        <div class="lecturers-content-wrapper">
                        ...
                        <li class="wow bounceInUp" data-wow-duration="2s" data-wow-delay=".1s">
                            ...
                            <div class="event-content-holder">
                                ...
                                <p>Pellentese turpis dignissim amet area ducation process facilitating Knowledge. Pellentese
                                    ...
                                    dignissim amet area ducation.</p>
                                <ul>
            ...
            <div class="rc-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="false"
                    ...
                    <div class="single-item-wrapper">
                        <div class="profile-img-wrapper">
                            <a href="#" class="profile-img"><img class="profile-img-responsive img-circle"
                                    src="assets/img/students/1.jpg" alt="Testimonial"></a>
                        </div>
                ...
                <div class="single-item">
                    <div class="single-item-wrapper">
                        <div class="profile-img-wrapper">
                            <a href="#" class="profile-img"><img class="profile-img-responsive img-circle"
                                    src="assets/img/students/2.jpg" alt="Testimonial"></a>
                        </div>
                        <div class="tlp-tm-content-wrapper">
                ...
                <div class="students-join1-left">
                    <div id="ri-grid" class="author-banner-bg ri-grid header text-center">
                        <ul class="ri-grid-list">
                            <li>
                                <a href="#"><img src="assets/img/students/student1.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student2.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student3.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student4.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student5.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student6.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student7.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student8.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/img/students/student1.jpg" alt=""></a>
                            </li>
